...
pub struct Account {
    ...
    // 每日配额剩余百分比 (0-100)
    #[serde(default, rename = "dailyQuotaRemainingPercent")]
    pub daily_quota_remaining_percent: Option<i32>,
    // 每周配额剩余百分比 (0-100)
    #[serde(default, rename = "weeklyQuotaRemainingPercent")]
    pub weekly_quota_remaining_percent: Option<i32>,
    // 每日配额重置时间戳
    #[serde(default, rename = "dailyQuotaResetTimestamp")]
    pub daily_quota_reset_timestamp: Option<i64>,
    // 每周配额重置时间戳
    #[serde(default, rename = "weeklyQuotaResetTimestamp")]
    pub weekly_quota_reset_timestamp: Option<i64>,
    // 自定义排序顺序（用于拖拽排序）
...
impl Account {
    pub fn new(email: String, password: String, nickname: String, tags: Vec<String>) -> Self {
        Self {
            ...
            daily_quota_reset_timestamp: None,
            weekly_quota_reset_timestamp: None,
            sort_order: 0,
        }
    }
